...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
      <div class="col-25">
        <label for="fname">ชื่อโครงงาน</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname">ผู้จัดทำ</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="fname">อัพโหลดภาพ</label>
      </div>
      <div class="col-75">
        <input type="text" id="fname" name="title" placeholder="">
      </div>
    ...
    <div class="row">
      <div class="col-25">
        <label for="fname">อัพโหลดไฟล์</label>
      </div>
      <div class="col-75">
        <input type="text" id="fname" name="title" placeholder="">
      </div>
    ...
    <div class="row">
      <div class="col-25">
        <label for="country">ระเภทโคงาน</label>
      </div>
      <div class="col-75">
        ...
        <option value=""></option>
          ...
          <option value="gmae">gmae</option>
        </select>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="subject">รายละเอียดชิ้นงาน</label>
      </div>
      <div class="col-75">
